			...
			if (m.body != null) {
				...
				foreach (Parameter param in m.get_parameters ()) {
					...
					if (param.direction != ParameterDirection.OUT) {
						...
						var vardecl = new CCodeVariableDeclarator.zero (get_variable_cname ("_vala_" + param.name), default_value_for_type (param.variable_type, true), get_ccode_declarator_suffix (param.variable_type));
